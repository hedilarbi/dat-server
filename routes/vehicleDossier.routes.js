...
const { vendeurOnly, vendeurOrAdmin } = require('../middlewares/role.middleware');
...
router.post('/media/blur', vendeurOrAdmin, vehicleDossierController.blurMedia);
router.post('/media/pdf-pages', vendeurOrAdmin, vehicleDossierController.getPdfPages);
router.post('/media/pdf-blur', vendeurOrAdmin, vehicleDossierController.blurPdf);
